            ...
            <form action="record-detail.php" method="GET">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="input-field col s4">
                            <input class="text-input" name="lastname" type="text" value="<?php echo isset($lastname) ? $lastname : '' ?>"/>
                            <label for="query">Last Name</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            <input class="text-input" name="description" type="text" value="<?php echo isset($description) ? $description : '' ?>"/>
                            <label for="query">Description</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s8">
                            <input class="text-input" name="street" type="text" value="<?php echo isset($street) ? $street : '' ?>"/>
                            <label for="query">Street</label>
                        </div>
                        <div class="input-field col s4">
                            <input class="text-input" name="unit" type="text" value="<?php echo isset($unit) ? $unit : '' ?>"/>
                            <label for="query">Unit</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s7">
                            <input class="text-input" name="city" type="text" value="<?php echo isset($city) ? $city : '' ?>"/>
                            <label for="query">City</label>
                        </div>
                        <div class="input-field col s2">
                            <input class="text-input" name="state" type="text" value="<?php echo isset($state) ? $state : '' ?>"/>
                            <label for="query">State</label>
                        </div>
                        <div class="input-field col s3">
                            <input class="text-input" name="zipcode" type="text" value="<?php echo isset($zipcode) ? $zipcode : '' ?>"/>
                            <label for="query">ZIP</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea class="materialize-textarea" rows="4" id="notes" name="notes" value="<?php echo isset($notes) ? $notes : '' ?>"></textarea>
